...
%                             1 x nChn vector holding autocorrelation width
%        :[struct outparams]- structure with fields listing parameters used

function [featV, outparams] = feat_act(Dat, inparams)
...
for iChn1=1:nChn
    ...
    C = xcorr(Dat.data(iChn1,:), maxlagidx, param.scaleopt);
